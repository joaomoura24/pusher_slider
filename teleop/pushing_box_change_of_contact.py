...
# User specified
body_width = 0.3  # width of body - along x axis
body_height = 0.3  # height of body - along y axis
...
pi = numpy.pi
xB0 = 1  # initial x-position of body in world
yB0 = 1  # initial y-position of body in world
thetaB0 = 0.0  # initial heading of body in world
phiP0 = numpy.deg2rad(20)  # initial angle of pusher in body frame
